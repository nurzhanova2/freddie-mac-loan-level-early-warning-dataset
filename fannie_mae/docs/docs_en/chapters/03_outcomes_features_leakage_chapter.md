...
than retrospective classification.
...
observation is censored rather than labelled as a non-event.
...
**Figures 3.2–3.3** and the [stage-11 report](../11_exploratory_data_analysis_report.md).
