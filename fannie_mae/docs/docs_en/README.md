# Dissertation sections — Fannie Mae, English

This directory contains materials applicable only to the Fannie Mae Primary
Dataset. They do not apply to the Freddie Mac workstream.
...
- [Stages 1–3](01_03_execution_report.md) — design and data-structure log.
- [Stages 4–6](04_06_execution_report.md) — reproducible download, quality-control and panel-construction log.
- [Stages 7–9](07_09_execution_report.md) — glossary import, leakage register and label construction.
- [Stage 10](10_cohort_extension_execution_report.md) — acquisition-cohort expansion.
- [Stage 11](11_exploratory_data_analysis_report.md) — exploratory analysis, tables, figures, and feature decisions.
